...
export const Contact = ({ showContact, setShowContact }) => {
  ...
  return (
    ...
    <div className={showContact ? "inline-block container-contact" : "d-none"} style={{ border: "1px solid #00B8FF", padding: "10px", maxWidth: "50% !important" }}>
      <div>
        <h3
          style={{
            fontSize: "1.5rem",
        ...
        <img src={close} className="btn-close-contact" onClick={()=> {setShowContact(false)}}/>
      </div>
      ...
      <div className="mb-3">
        ...
        <div className="p-2">
        <button className="__boton-mediano enphasis-button" style={{width: "200px"}} onClick={handleSubmit}>
